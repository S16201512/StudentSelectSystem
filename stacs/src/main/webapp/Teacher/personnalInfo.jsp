...
<div style=";width:100%;height: 85%;border-bottom: 1px solid black  ;background-color: rgba(218,255,253,0.81)">
    ...
    <div style="width: 83.7%;height: 100%;border: 0px solid black ;float:left ">
        ...
        <div style="width: 100.3%;height: 30px;border-bottom: 0px solid black;padding:0px;margin:0px;background-color:#1babb3;text-align: left;color:snow">
            个人资料
        </div>
        <div style="text-align: right;width: 57%;position:relative">
            <div style="height: 30px;">
                教师编号：<input type="text" readonly name = "id" value="${teacher.getId()}">
            </div>
            <div style="height: 30px;">
                教师姓名：<input type="text" readonly name = "name" value="${teacher.getUsername()}">
            </div>
            <div style="height: 30px;">
                性别：<input type="text" readonly name = "gender" value="${teacher.getGender()}">
            </div>
            <div style="height: 30px;">
                联系方式：<input type="text" readonly name = "phone" value="${teacher.getTphone()}">
            </div>
            <div style="height: 30px;">
                qq邮箱：<input type="textarea" readonly name = "email" value="${teacher.getTemail()}">
            </div>
