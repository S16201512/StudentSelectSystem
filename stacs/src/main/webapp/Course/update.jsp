...
<div style="width: 100%;height: 10%;border: 0px solid black ;background-color: rgba(218,255,253,0.81)">
    ...
    <div style=";width:100%;height: 85%;border-bottom: 1px solid black ;background-color: rgba(218,255,253,0.81) ">
        ...
        <div style="width: 83.7%;height: 100%;border: 0px solid black ;float:left ">
            ...
            <div style="width: 100%;height: 30px;border-bottom: 1px solid #1babb3;text-align: center">
                修改课程
            </div>
            <div style="text-align: center">
                <form method="post" action="/course/update">
                    <% String id = request.getParameter("id");
                        request.getSession().setAttribute("upCno",id);
                    %>

                    <input TYPE="hidden" name = "Cno"  value = "id"><br>

                    <input TYPE="text" name = "Cname" placeholder="请输入修改后的课程名称"><br>
                    <input TYPE="text" name = "Time_out" placeholder="请输入修改后的课程课时"><br>
                    <input TYPE="number"  style="width: 11.1%;" name = "Credit" min="0.5" max="4.0" step="0.5" placeholder="输入学分" }><br>
                    <c:if test = "${not empty nmsg1}">
                        <div style="color: red;">${nmsg1}</div>
                    </c:if>
                    <div style="left: 53.5%;position: absolute;">
                        <input  type="submit">
                    </div>
                    <div style="right: 37.5%;position: absolute">
