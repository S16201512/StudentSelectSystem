    ...
    <div style="width: 83.7%;height: 100%;border:0px solid black ;float:left ">
        ...
        <div style="text-align: center">
            <div style="height: 30px;text-align: center">
                <input type="text" readonly name = "Cno" value="${course.getCno()}">
            </div>
            <div style="height: 30px;text-align: center">
                <input type="text" readonly name = "Cname" value="${course.getCname()}">
            </div>
            <div style="height: 30px;text-align: center">
                <input type="text" readonly name = "Time_out" value="${course.getTime_out()}">
            </div>
            <div style="height: 30px;text-align: center">
                <input type="text" readonly name = "Credit" value="${course.getCredit()}">
            </div>
            <div style="height: 30px;text-align: center">
                <input type="textarea" readonly name = "Credit" value="${course.getCintroduction()}">
            </div>
