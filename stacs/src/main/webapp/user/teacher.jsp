<%@ page import="com.nchu.entity.Teacher" %><%--
...
<body>
    <%--logo模块--%>
    <a href="/user/teacher.jsp">
    <div style="width: 100%;height: 10%;margin:0px;padding:0px;border:0px;background-color: rgba(218,255,253,0.81)">
    ...
    <%--功能跳转栏--%>
    <div style="width: 100%;height: 2.7%;border-bottom: 1px solid black ;background-color: #1babb3;">
    ...
    <div style=";width:100%;height: 85%;border-bottom: 1px solid black ; background-color: rgba(218,255,253,0.81)">
        ...
        <div style="width:16%;height: 100%;border-right: 1px solid black ;float:left ">
            ...
            <div style="font-family: 楷体;color: #1babb3;float: left;position: relative;font-size: 30px;">
                <c:if test="${not empty user}">
                    <div style="font-family: 楷体;color: #1babb3;font-size: 20px;">您好,${user.username}老师,欢迎来到南昌航空大学选课系统！ </div>
                </c:if>
            </div>
        <%--右侧显示与操作模块--%>
        <div style="width: 83.7%;height: 100%;border: 0px solid black ;float:left ">

            <div style="width: 100%;height: 30px;border: 0px solid #1babb3;text-align: center">
                课程列表
            </div>
            <a  style="position:relative;height: 50px;left:10px;" href="/Course/courseAdd.jsp">添加课程</a>
            <c:if test="${empty courseList}" >
                <h1 style="color:#ff0000;left: 20px;">
                    还没有课程，请<a href="/Course/courseAdd.jsp" style="color:#ff0000;text-decoration: none">添加</a>
                </h1>
            </c:if>

            <div style="width: 100%;border-top: 1px solid black;height: 3%;">
                <div  style="width:12.5%;float: left;text-align: center">课程号</div>
                <div  style="width:12.5%;float: left;text-align: center">课程名称</div>
                <div  style="width:12.5%;float: left;text-align: center">课时</div>
                <div  style="width:12.5%;float: left;text-align: center">学分</div>
                <div  style="width:12.5%;float: left;text-align: center">|</div>
                <div  style="width:37.5%;float: left;text-align: center">操作</div>
                <br>
                <br>
            </div>
            <c:if test="${ not empty courseList}">
                <c:forEach items="${courseList}" var="list">
                    <div style="width: 100%;border: 1px solid black;">
                        <div  style="width:12.5%;text-align: center;float: left;">${list.getCno()}</div>
                        <div  style="width:12.5%;text-align: center;float: left;">${list.getCname()}</div>
                        <div  style="width:12.5%;text-align: center;float: left;">${list.getTime_out()}</div>
                        <div  style="width:12.5%;text-align: center;float: left;">${list.getCredit()}</div>
                        <div  style="width:12.5%;text-align: center;float: left;">|</div>
                        <div  style="width:12.5%;float: left;text-align: center">
                            <a href="/Course/update.jsp?id=${list.getCno()}">修改</a>
                        </div>
                        <div  style="width:12.5%;float: left;text-align: center">
                            <a href="/course/detail?id=${list.getCno()}">详情</a>
                        </div>
                        <div  style="width:12.5%;float: left;text-align: center">
                            <a href="/course/delete?id=${list.getCno()}">删除</a>
                        </div>
                    </div>
                    <br>
                </c:forEach>
            ...
            <div style="bbackground-color: rgba(218,255,253,0.81)">
                <tr>
