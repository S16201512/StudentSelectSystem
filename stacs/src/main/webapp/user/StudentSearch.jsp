...
<div style=";width:100%;height: 85%;border-bottom: 1px solid black ;">
    ...
    <div style="width: 83.7%;background-color: #e8f9fb;height: 100%;border: 0px solid black ;border-bottom:0px solid black;border-left:0px solid black;float:left ">
        ...
        <div style="width: 100%;border-top: 0px solid black;height: 2.7%;background-color:#1babb3">
            <div  style="width:20%;float: left;text-align: center">学生编号</div>
            <div  style="width:20%;float: left;text-align: center">学生姓名</div>
        ...
        <c:if test="${ not empty studentList}">
            <c:forEach items="${studentList}" var="list">
                <div style="width: 100%;border: 1px solid black;">
                    ...
                    <div  style="width:20%;text-align: center;float: left;">${list.getStele()}</div>
                    <div  style="width:20%;text-align: center;float: left;">${list.getSmail()}</div>
                </div>
                <br>
            </c:forEach>
        </c:if>
