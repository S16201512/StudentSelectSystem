...
<div style=";width:100%;height: 85%;border-bottom: 1px solid black ;">
    ...
    <%--右侧显示与操作模块--%>
        <div style="width: 100%;height: 100%;border: 1px solid black ;text-align: center;background-color: #e8f9fb; ">
            <form method="post" action="/servlet/passwordreset" style="text-align: center;padding-top: 100px;line-height: 45px">
                <div>
                    <b>用户编号：</b><input type="text" name="id">
                    <select name="identity" style="height: 22px">
